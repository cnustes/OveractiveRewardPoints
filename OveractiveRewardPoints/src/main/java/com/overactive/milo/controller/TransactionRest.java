...
public class TransactionRest 
{
	...
	@PostMapping
	public ResponseEntity<Object> createTransaction(@Valid @RequestBody Transaction transaction, BindingResult result)
	{
	...
	@PreAuthorize("hasRole('ADMIN')")
	@PutMapping(value = "/{id}")
	public ResponseEntity<Object> updateTransaction(@PathVariable("id") Long transactionId,@Valid @RequestBody Transaction transaction, BindingResult result)
	{
